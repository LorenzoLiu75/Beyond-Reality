<?php 
  ...
  if(isset($_POST['addDivisi'])) {
    ...
    $id = $_POST['idDivisi'];
    $name = $_POST['namaDivisi'];
    

    $sql = "INSERT INTO divisi (id_divisi, nama_divisi) VALUES ('$id', '$name')";
    ...
    if($result) {
      ...
      $msg = "<div class='alert alert-danger'>Add divisi is failed</div>";
    }
  }
?>
            ...
            <div class="card-body p-4">
              ...
              <form action="" method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="namaDivisi" id="nama">
                </div>
                <button type="submit" name="addDivisi" class="btn btn-primary">Add</button>
